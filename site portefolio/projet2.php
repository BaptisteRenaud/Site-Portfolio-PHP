...
<body>
    ...
    <section id="project1" class="section">
        <div class="container">
            <br>
            <h2><?php echo $Projet[1]["Name"]?></h2>
            <br><br>
            <p><?php echo $Projet[1]["Description"]?></p>
            <br><br>
            <strong><?php echo "Résultat"?></strong>
            <br>
            <li><?php echo $Projet[1][3]?></li>
            <li><?php echo $Projet[1][4]?></li>
            <li><?php echo $Projet[1][5]?></li>
            <br>
        </div>
    </section>
