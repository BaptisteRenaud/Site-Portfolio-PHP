...
<body>
    ...
    <section id="project1" class="section">
        <div class="container">
            <br>
            <h2><?php echo $Projet[3]["Name"]?></h2>
            <br>
            <p><?php echo $Projet[3]["Description"]?></p>
            <br>
            <strong><?php echo "IDENTIFICATION DES RIQUES :"?></strong>
            <br><br>
            <li><?php echo $Projet[3][3]?></li>
            <li><?php echo $Projet[3][4]?></li>
            <li><?php echo $Projet[3][5]?></li>
            <br>
        </div>
    </section>
